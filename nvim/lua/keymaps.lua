...
-- === TERMINAL ===
vim.keymap.set("n", "<leader>tf", ":terminal<CR>", { desc = "Terminal in full screen" })
...
vim.keymap.set("n", "<leader>w-", ":vertical resize -10<CR>", { desc = "Decrement vertical width", noremap = "true" })
vim.keymap.set("n", "<leader>wu", ":resize +10<CR>", { desc = "Increment Horizontal height", noremap = "true" })
vim.keymap.set("n", "<leader>wd", ":resize -10<CR>", { desc = "Decrecent Horizontal height", noremap = "true" })
vim.keymap.set("n", "<leader>wx", ":close!<CR>", { desc = "Close window", noremap = "true" })
...
-- === NEOVIM ===
vim.keymap.set("n", "<leader>nu", ":update<CR>", { desc = "Update all", noremap = "true" })
vim.keymap.set("n", "<leader>nw", ":w<CR>", { desc = "Save document", noremap = "true" })
vim.keymap.set("n", "<leader>nr", ":restart<CR>", { desc = "Restart Neovim", noremap = "true" })


-- === CLIPBOARD ===
vim.keymap.set("n", "<leader>ra", "\"ay", { desc = "copy in registry A", noremap = "true" })
vim.keymap.set("n", "<leader>ra", "\"ap", { desc = "paste in registry A", noremap = "true" })
vim.keymap.set("n", "<leader>rr", ":reg", { desc = "See all registers", noremap = "true" })
